                ...
                <div className="bg-white rounded-2xl mt-4 border border-emerald-100/60 shadow-lg shadow-emerald-900/4 overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        {activeWorkflow === 'approve' && (
                            <div id="assignControlNumber" className="mb-4">
                                <label className="block text-xs font-bold tracking-wider text-amber-500 mb-2 italic">
                                    Note: Control Number Reference will be auto generated by the system.
                                </label>
                            </div>
                        )}
