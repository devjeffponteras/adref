...
export default function UserManagementEdit({ user, roles = [] }: EditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/admin/user-management/update', {
            onSuccess: () => {
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-xs overflow-hidden">
                    ...
                    <div className="p-5 border-b border-gray-200 bg-gray-50/50">
                        <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                            <Edit3Icon className="h-5 w-5 text-emerald-700" />
                            Modify System User Profile
                        </h2>
                        <p className="mt-1 text-xs text-gray-500">
                            Update account operational details, adjust system privileges, or issue a password reset.
                        </p>
                    </div>

                    {/* Modification Form Block */}
